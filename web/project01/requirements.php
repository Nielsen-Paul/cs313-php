		...
		<?php echo $youth_name ?> </h1>
			...
			while ($row = $statement->fetch(PDO::FETCH_ASSOC)): ?>
				<form action="input.php" method="POST">
					...
					<label> Learn - </label><input type="checkbox" name="learn" value="yes" <?php if ($row['learn' == 1]) echo "checked='checked'"; ?> />
					<label> Act - </label><input type="checkbox" name="act" value="yes" <?php if ($row['act' == 1]) echo "checked='checked'"; ?> />
					<label> Share - </label><input type="checkbox" name="share" value="yes" <?php if ($row['share' == 1]) echo "checked='checked'"; ?> />
